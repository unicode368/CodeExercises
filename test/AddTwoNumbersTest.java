...
public class AddTwoNumbersTest {
    ...
    public void testSameSizes() {
        ...
        Assertions.assertEquals(AddTwoNumbers.addTwoNumbers(l1, l2),
                AddTwoNumbers.createList(new int[]{7,0,8}));
    }
    ...
    public void testDifferentSizes() {
        ...
        Assertions.assertEquals(AddTwoNumbers.addTwoNumbers(l1, l2),
                AddTwoNumbers.createList(new int[]{8,9,9,9,0,0,0,1}));
    }
    ...
    public void testZeros() {
        ...
        Assertions.assertEquals(AddTwoNumbers.addTwoNumbers(l1, l2),
                AddTwoNumbers.createList(new int[]{0}));
    }
}
